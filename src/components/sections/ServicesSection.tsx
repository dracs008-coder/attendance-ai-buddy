              ...
              {services.map((svc: any) => (
                ...
                >
                  <ServiceCard
                    ...
                    purpose={(svc as any).purpose || (svc as any).category?.name}
                    price={typeof svc.price === 'number' ? Number(svc.price) : undefined}
                    icon={svc.icon}
                    unavailable={(svc as any).unavailable}
                  />
                </div>
              ))}
                ...
                >
                  <div className="space-y-3 sm:space-y-4">
                    ...
                    <p className="text-xs sm:text-sm text-white/80 max-w-xs">
                      Explore all the services we offer for repairs, upgrades, and ongoing support.
                    </p>
                  </div>
