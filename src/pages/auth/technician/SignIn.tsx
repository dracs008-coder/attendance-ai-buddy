...
export default function TechnicianSignIn() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setLoading(true);
    setTimeout(() => {
      toast.success("Technician signed in (demo)");
      setLoading(false);
    }, 800);
  };
      ...
      <AuthCard>
        <div className="mb-6 text-center">
          ...
          <p className="text-sm text-gray-600">
            No account?{' '}
            <Link to="/auth/technician/sign-up" className="text-blue-600 underline">
              Apply to be a technician
            </Link>
          </p>
        </div>
        ...
        <div className="space-y-2 text-center mt-6 text-sm">
          ...
          <p>
            New technician?{' '}
            <Link to="/auth/technician/sign-up" className="text-blue-600 underline">Apply here</Link>
          </p>
        </div>
      </AuthCard>
    </div>
